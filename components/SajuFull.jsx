...
export default function SajuFull(){
  ...
  if(view==='landing') return(
    <div style={base}>
      ...
      {popup&&<DiscountPopup/>}
      <nav style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'16px 32px',borderBottom:`1px solid ${V.br}`,position:'sticky',top:0,background:V.bg,zIndex:50}}>
        <div style={{width:40}}></div>
        <img src="/logo_bf.png" alt="BORN FROM" style={{height:36,objectFit:'contain'}}/>
        <div style={{display:'flex',gap:24,alignItems:'center'}}>
          <a href="#shop" style={{fontSize:12,letterSpacing:3,color:V.tx,textDecoration:'none',fontWeight:500}}>SHOP</a>
          <a href="#story" style={{fontSize:12,letterSpacing:3,color:V.tx,textDecoration:'none',fontWeight:500}}>ABOUT</a>
        </div>
      </nav>
  ...
  return <div style={base}/>;
      ...
      <section style={{position:'relative',width:'100%',overflow:'hidden'}}>
        {/* Hero image - prism */}
        <img src="/hero_prism.png" alt="Fate is just a pattern you haven't decoded yet." 
          style={{width:'100%',display:'block',maxHeight:'70vh',objectFit:'cover',objectPosition:'center'}}/>
      </section>

      {/* HERO WOMAN */}
      <section id="story" style={{position:'relative',width:'100%',overflow:'hidden',borderTop:`1px solid ${V.br}`}}>
        <img src="/hero_woman.png" alt="Born From" 
          style={{width:'100%',display:'block',maxHeight:'60vh',objectFit:'cover',objectPosition:'center top'}}/>
      </section>
