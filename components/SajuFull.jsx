        ...
        <div style={{maxWidth:580,margin:'0 auto',padding:'56px 24px 80px',textAlign:'center'}}>
          ...
          <div className="ri5" style={{marginBottom:40}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10,marginBottom:10,gridAutoRows:'1fr'}}>
              {[
                {id:'basic',ko:'Basic Fortune',price:'$44.99',orig:'$19.99',desc:'Full destiny + K-pop idol match',icon:'命',hot:true},
                {id:'story',ko:'The Life Script',price:'$44.99',orig:'$69.99',desc:'Your life as a Korean fairy tale',icon:'✦',hot:false,sig:true},
                {id:'love',ko:'The Relationship Decoder',price:'$29.99',orig:null,desc:'Your ideal partner revealed',icon:'♡',hot:false},
                {id:'career',ko:'The Success Compass',price:'$29.99',orig:null,desc:'Your destined paths & power years',icon:'山',hot:false},
              ].map(pkg=>(
                <div key={pkg.id}
