...
const IDOLS={'甲':[{name:'Jin',group:'BTS'},{name:'Rosé',group:'BLACKPINK'}],'乙':[{name:'G-Dragon',group:'BIGBANG'},{name:'V',group:'BTS'}],'丙':[{name:'Nayeon',group:'TWICE'}],'丁':[{name:'IU',group:'Solo Artist'},{name:'Jimin',group:'BTS'}],'戊':[{name:'Lisa',group:'BLACKPINK'}],'己':[{name:'Karina',group:'aespa'}],'庚':[{name:'Suga',group:'BTS'}],'辛':[{name:'RM',group:'BTS'}],'壬':[{name:'Baekhyun',group:'EXO'}],'癸':[{name:'Jennie',group:'BLACKPINK'}]};
