          ...
          <div className="ri5" style={{marginBottom:40}}>
            <div style={{background:V.s,border:`2px solid ${V.am}`,padding:'28px 24px',textAlign:'center'}}>
              ...
              <div style={{borderTop:`1px solid ${V.br}`,borderBottom:`1px solid ${V.br}`,padding:'20px 0',marginBottom:24}}>
                ...
                <p style={{fontSize:22,color:V.tx,fontWeight:600,lineHeight:1.4,marginBottom:6}}>One K-beauty sheet mask for your skin.</p>
                <p style={{fontSize:22,color:V.am,fontWeight:600,lineHeight:1.4}}>One K-Saju reading for your love life.</p>
              </div>
